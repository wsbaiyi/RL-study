...
class GridWorld_v4(object):
    ...
    def __init__(self, initState=10, rows=4, columns=5, forbiddenAreaNums=3, targetNums=1, seed=-1, score=1, forbiddenAreaScore=-1,
                 desc=None):
    ...
    def step(self,action):
        score, nextState = self.getScore(self.nowState, action)
